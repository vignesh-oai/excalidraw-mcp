...
export function registerTools(server: McpServer, distDir: string, store: CheckpointStore): void {
  ...
  const generatedV14NestedConnectorPrivateViewResourceUri = "connectors://asdk_app_69e86c8e52c48191b77421c0bb2b71b7/asdk_app_69e86c8e52c48191b77421c0bb2b71b7/link_69e86cde6fe881919e537b98eb3d415c/create_private_view";
...
Use this to verify that a protected tool can coexist with public tools on the same MCP server.`,
  ...
  const widgetResourceDomains = [widgetDomain, "https://esm.sh"];
  const cspMeta = {
    ui: {
      domain: widgetDomain,
      csp: {
        resourceDomains: widgetResourceDomains,
        connectDomains: widgetResourceDomains,
      },
    },
    ...
    "openai/widgetCSP": {
      ...
      connect_domains: widgetResourceDomains,
    },
  };
